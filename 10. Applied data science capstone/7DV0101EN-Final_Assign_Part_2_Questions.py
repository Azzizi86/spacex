...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        exp_rec = recession_data[recession_data['Recession']==1]
        R_chart3 = dcc.Graph(
            figure = px.pie(exp_rec,values = exp_rec['Advertising_Expenditure'],names=exp_rec['Vehicle_Type'],title = 'Total Expenditure sahre by type during Recession')
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure = px.pie(exp_data,names= 'Vehicle_Type',values = 'Advertising_Expenditure',title = 'Total Advertisment Expense for Each Vehicles'))
